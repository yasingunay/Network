...
def following_view(request):
    ...
    paginator = Paginator(
        post_list, POST_NUMBER_PER_PAGE
...
def edit(request, post_id):
    if request.method == "POST":
        ...
        response_data = {"message": "Change successful", "data": data["content"]}
